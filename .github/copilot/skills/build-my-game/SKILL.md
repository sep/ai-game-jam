...
- NEVER create external JS/CSS files — everything in one HTML file
- ALWAYS use Three.js r128 from CDN
- ALWAYS make games that work when opened directly in a browser
- Keep the game under 500 lines if possible — clean, readable code
- Add code comments explaining key sections so participants can learn
